...
export 'products/animal_products_screen.dart';
export 'products/recommender_screen.dart';
...
// Ofertas Flash
export 'ofertas/ofertas_screen.dart';

// Favorites
export 'favorites/favorites_screen.dart';

// Info
export 'info/contact_screen.dart';
export 'info/faq_screen.dart';
export 'info/envios_screen.dart';
export 'info/sobre_nosotros_screen.dart';

// Legal
export 'legal/privacidad_screen.dart';
export 'legal/terminos_screen.dart';
export 'legal/cookies_screen.dart';

// Admin
export 'admin/admin_dashboard_screen.dart';
export 'admin/admin_orders_screen.dart';
export 'admin/admin_products_screen.dart';
export 'admin/admin_product_form_screen.dart';
